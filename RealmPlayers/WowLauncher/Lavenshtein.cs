...
{
    //Taken from http://www.codeproject.com/Articles/13525/Fast-memory-efficient-Levenshtein-algorithm
    public class LevenshteinAlgorithm
    {
        ...
        ///*****************************
        public static int FasterLD(String sRow, String sCol)
        {
        ...
        /// Compute Levenshtein distance         
        ///*****************************
        public static int OriginalLD(String sNew, String sOld)
        {
            int[,] matrix;              // matrix
