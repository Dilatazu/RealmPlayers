...
namespace VF_RealmPlayersDatabase.PlayerData.PlayerHistoryUtility
{
    ...
    {
        public static bool RunGeneric_T<T_HistoryItem>(List<T_HistoryItem> _HistoryArray, T_HistoryItem _NewHistoryItem, Func<T_HistoryItem, T_HistoryItem, bool> _IsSame, Func<T_HistoryItem, T_HistoryItem, bool> _Time1BiggerThan2, Func<T_HistoryItem, T_HistoryItem, bool> _CopyUploader2To1)
        {
            ...
            for (int i = _HistoryArray.Count - 1; i >= 0; --i)
            {
                ...
                {//If _NewHistoryItem.Date >= currData.Date
                    if (_IsSame(currData, _NewHistoryItem) == true)
                        return false;//Datan existerar redan och är tidigare nersparad
                    else
                    {
        ...
        public static bool RunGeneric(List<CharacterDataHistoryItem> _HistoryArray, CharacterData _Data, UploadID _Uploader)
        {
            return RunGeneric_T(_HistoryArray, new CharacterDataHistoryItem(_Data, _Uploader), CharacterDataHistoryItem.IsSame, CharacterDataHistoryItem.Time1BiggerThan2, CharacterDataHistoryItem.CopyUploader2To1);
        }
        public static bool RunGeneric(List<GuildDataHistoryItem> _HistoryArray, GuildData _Data, UploadID _Uploader)
        {
            return RunGeneric_T(_HistoryArray, new GuildDataHistoryItem(_Data, _Uploader), GuildDataHistoryItem.IsSame, GuildDataHistoryItem.Time1BiggerThan2, GuildDataHistoryItem.CopyUploader2To1);
        }
        ...
        public static bool RunGeneric(List<HonorDataHistoryItem> _HistoryArray, HonorData _Data, UploadID _Uploader)
        {
            return RunGeneric_T(_HistoryArray, new HonorDataHistoryItem(_Data, _Uploader), HonorDataHistoryItem.IsSame, HonorDataHistoryItem.Time1BiggerThan2, HonorDataHistoryItem.CopyUploader2To1);
        }
        ...
        public static bool RunGeneric(List<TalentsDataHistoryItem> _HistoryArray, string _Data, UploadID _Uploader)
        {
            return RunGeneric_T(_HistoryArray, new TalentsDataHistoryItem(_Data, _Uploader), TalentsDataHistoryItem.IsSame, TalentsDataHistoryItem.Time1BiggerThan2, TalentsDataHistoryItem.CopyUploader2To1);
        }
    }
}
