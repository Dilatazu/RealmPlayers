...
namespace VF_WoWLauncherServer
{
    class AddonDatabaseService
    {
        ...
        public static string g_AddonUploadDataFolder = VF_RealmPlayersDatabase.Utility.DefaultServerLocation + "VF_DataServer\\AddonUploadedData\\";
        public static string g_AddonUploadStatsFolder = VF_RealmPlayersDatabase.Utility.DefaultServerLocation + "VF_DataServer\\AddonUploadedDataStats\\";
