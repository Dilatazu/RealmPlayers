...
namespace RealmPlayersServer
{
    public partial class Contributors : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var contributorStatistics = DatabaseAccess.GetContributorStatistics();

            m_BreadCrumbHTML = new MvcHtmlString(PageUtility.BreadCrumb_AddHome() + PageUtility.BreadCrumb_AddFinish("Contributors"));

            var statisticsData = contributorStatistics.GetContributorStatisticsData();
            ...
            m_TableHeadHTML = new MvcHtmlString(PageUtility.CreateTableRow("", PageUtility.CreateTableColumnHead("#Nr") 
                ...
                + PageUtility.CreateTableColumnHead("Inspects(ED)")
                + PageUtility.CreateTableColumnHead("Inspects(WSG)")
                + PageUtility.CreateTableColumnHead("Inspects(AlA)")
                + PageUtility.CreateTableColumnHead("Inspects(REB)")
                + PageUtility.CreateTableColumnHead("Inspects(ArA)") 
