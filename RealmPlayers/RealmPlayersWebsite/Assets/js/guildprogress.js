...
instanceBosses["ZG"][6] = "Bloodlord Mandokir";
...
function generateProgress(guildName, instance) {
    ...
    var preStr = '<div class="raid_progress" id="' + guildName + '-' + instance + '" rel="bootstraptooltip" >';
...
function generateProgressGuildView(guildName, instance) {
    var progressValue = generateProgressValue(guildProgress[guildName][instance]);
    var preStr = '<div class="raid_progress" id="' + guildName + '-' + instance + '" rel="bootstraptooltip" style="white-space: nowrap;">';
...
function createProgressTooltip($, guildName, instance) {
    $("div#" + guildName + "-" + instance).bootstraptooltip({
        html: true,
        placement: "bottom",
