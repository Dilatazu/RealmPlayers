...
function InitializeChart(_Labels, _Data, _Width, _Height, _Top, _Left, _ChartDivID, _ChartPopupDataFunc, _ChartPopupLabelFunc) {
    g_ChartLabels = _Labels;
    g_ChartData = _Data;
    g_ChartWidth = _Width;
    g_ChartHeight = _Height;
    g_ChartTop = _Top;
    g_ChartLeft = _Left;
    g_ChartID = _ChartDivID;
    g_ChartPopupDataFunc = _ChartPopupDataFunc;
    g_ChartPopupLabelFunc = _ChartPopupLabelFunc;
    ...
    window.onload = function () {
        ...
        var width = g_ChartWidth,
            ...
            max = Math.max.apply(Math, g_ChartData),
        ...
        for (var i = 0, ii = g_ChartLabels.length; i < ii; i++) {
            ...
            })(x, y, g_ChartData[i], g_ChartLabels[i], dot);
        }
        p = p.concat([x, y, x, y]);
