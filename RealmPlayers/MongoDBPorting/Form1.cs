...
namespace MongoDBPorting
{
    public partial class Form1 : Form
    {
        ...
        private void MigrateRealmDBs_Click(object sender, EventArgs e)
        {
            ...
            Database tempDatabase = new Database("C:\\VF_RealmPlayersData\\RPPDatabase\\Database\\");
        ...
        private void MigrateContributors_Click(object sender, EventArgs e)
        {
            try
            {
                VF_RealmPlayersDatabase.Deprecated.ContributorHandler.Initialize("C:\\VF_RealmPlayersData\\RPPDatabase\\Database\\");
