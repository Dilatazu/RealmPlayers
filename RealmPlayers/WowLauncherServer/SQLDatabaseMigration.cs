...
namespace VF_WoWLauncherServer
{
    public class SQLDatabaseMigration
    {
        ...
        public static void Migrate(MigrationChoice _MigrationChoice, WowRealm[] _Realms)
        {
            foreach (var realmToTry in _Realms)
            {
                try
                {
                    ...
                    if (_MigrationChoice == MigrationChoice.TestOnly)
                    {
                    ...
                    binRealm.LoadDatabase("G:\\VF_RealmPlayersData\\RPPDatabase\\Database\\" + binRealm.Realm.ToString(), new DateTime(2012, 5, 1, 0, 0, 0));//new DateTime(2015, 9, 1, 0, 0, 0));//, 
                    ...
                    if (_MigrationChoice == MigrationChoice.MigrateAndTest)
                    {
                        ...
                        foreach (var binPlayer in binRealm.Players)
                        {
                            try
                            {
                                ...
                                if (sqlHistory != null && binHistory != null)
                                {
                                    ...
                                    {
                                        if (sqlHistory.CharacterHistory.Count == 1 && binHistory.CharacterHistory.Count == 0)
                                        {
                                            //Ignore this case
                                        }
                                        else
                                    ...
                                    {
                                        if (sqlHistory.HonorHistory.Count == 1 && binHistory.HonorHistory.Count == 0)
                                        {
                                            //Ignore this case
                                        }
                                        else
                                    ...
                                    {
                                        if(sqlHistory.GuildHistory.Count == 1 && binHistory.GuildHistory.Count == 0)
                                        {
                                            //Ignore this case
                                        }
                                        else
                                    ...
                                    if (sqlHistory.ArenaHistory != null && binHistory.ArenaHistory != null)
                                    {
                                        ...
                                        {
                                            if (sqlHistory.ArenaHistory.Count == 1 && binHistory.ArenaHistory.Count == 0)
                                            {
                                                //Ignore this case
                                            }
                                            else
                                    ...
                                    if (sqlHistory.TalentsHistory != null && binHistory.TalentsHistory != null)
                                    {
                                        ...
                                        {
                                            if (sqlHistory.TalentsHistory.Count == 1 && binHistory.TalentsHistory.Count == 0)
                                            {
                                                //Ignore this case
                                            }
                                            else
