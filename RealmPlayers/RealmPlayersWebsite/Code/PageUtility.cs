...
namespace RealmPlayersServer
{
    ...
    public class PageUtility
    {
        ...
        public static string CreateGraph(List<int> _DataX, List<Tuple<List<int>, System.Drawing.Color>> _DataYs, List<string> _Labels, int _Width = 935, int _Height = 250)
        {
            string dataX = "";
            string dataYs = "";
            string dataYcolors = "";
