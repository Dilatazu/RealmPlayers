...
namespace VF
{
	...
	public class FolderSelectDialog
	{
        ...
        /// Shows the dialog
        /// </summary>
        /// <param name="_OwnerForm">Owner Form</param>
        /// <returns>True if the user presses OK else false</returns>
        public bool ShowDialog(System.Windows.Forms.Form _OwnerForm)
        {
            return ShowDialog(_OwnerForm.Handle);
        }
		...
		public bool ShowDialog(IntPtr hWndOwner)
		{
			...
			{
				var r = new Hidden.Reflector("System.Windows.Forms");
