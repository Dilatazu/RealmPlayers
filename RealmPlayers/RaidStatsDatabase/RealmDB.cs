...
namespace VF_RaidDamageDatabase
{
    ...
    public class RPPDatabase
    {
        ...
        private static VF_RealmPlayersDatabase.Database GetDatabase(string _DatabaseDirectory)// = VF_RealmPlayersDatabase.Utility.DefaultServerLocation + "VF_RealmPlayersData\\RPPDatabase\\Database\\")
        {
